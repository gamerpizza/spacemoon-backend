...
// NewTokenGenerator instantiates a new token generator and helps make sure that the tokens generated by it are random
// based on the current unix time
func NewTokenGenerator() TokenGenerator {
	rand.Seed(time.Now().Unix())
	return tokenGenerator{}
}

// TokenGenerator generates random tokens using TokenCharacters to create a Token of the designated size
